...
const AVATARS = [
  {
    id: "1",
    url: "/media/avatars/Ellipse1.png",
    fallback: "A1",
    name: "Ellipse1.png",
  },
  {
    id: "2",
    url: "/media/avatars/Ellipse2.png",
    fallback: "A2",
    name: "Ellipse2.png",
  },
  {
    id: "3",
    url: "/media/avatars/Ellipse3.png",
    fallback: "A3",
    name: "Ellipse3.png",
  },
  {
    id: "4",
    url: "/media/avatars/Ellipse4.png",
    fallback: "A4",
    name: "Ellipse4.png",
  },
  {
    id: "5",
    url: "/media/avatars/Ellipse5.png",
    fallback: "A5",
    name: "Ellipse5.png",
  },
  {
    id: "6",
    url: "/media/avatars/Ellipse6.png",
    fallback: "A6",
    name: "Ellipse6.png",
  },
  {
    id: "7",
    url: "/media/avatars/Ellipse7.png",
    fallback: "A6",
    name: "Ellipse7.png",
  },
  {
    id: "8",
    url: "/media/avatars/Ellipse8.png",
    fallback: "A6",
    name: "Ellipse8.png",
  },
];
    ...
    <div className="space-y-4">
      ...
      {Object.keys(imageError).length > 0 && (
        <div className="text-red-500 text-sm">
          Some avatar images failed to load. Make sure they exist in the public
          directory.
        </div>
      )}
