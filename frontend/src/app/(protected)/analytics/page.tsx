...
const AnalyticsDashboard = () => {
  ...
  return (
    <div className="bg-background min-h-screen p-4 md:p-6 font-inter relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-6">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-3xl font-bold text-foreground tracking-tight">Learning Analytics</h1>
            </div>
            <p className="text-secondary-foreground mt-1">Track your progress and optimize your learning journey</p>
          </div>

          <div className="flex flex-col sm:flex-row gap-3">
            <Tabs defaultValue="week" className="w-full sm:w-auto">
              <TabsList className="grid grid-cols-4 w-full sm:w-auto">
                <TabsTrigger value="today" onClick={() => setTimeRange(TimeRange.TODAY)}>
                  Today
                </TabsTrigger>
                <TabsTrigger value="week" onClick={() => setTimeRange(TimeRange.WEEK)}>
                  Week
                </TabsTrigger>
                <TabsTrigger value="month" onClick={() => setTimeRange(TimeRange.MONTH)}>
                  Month
                </TabsTrigger>
                <TabsTrigger value="all" onClick={() => setTimeRange(TimeRange.ALL)}>
                  All
                </TabsTrigger>
              </TabsList>
            </Tabs>
            ...
            <div className="grid grid-cols-1 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>This tab would contain more detailed performance metrics</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-secondary-foreground">
                    Detailed performance analytics would be displayed here, including learning efficiency, retention
                    rates, and more granular metrics.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>This tab would show your learning habit patterns</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-secondary-foreground">
                    Detailed analysis of your study habits, optimal times of day, consistency patterns, and
                    habit-building recommendations would appear here.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>This tab would track your progress toward learning goals</CardDescription>
                </CardHeader>
                <CardContent>
                  <p className="text-secondary-foreground">
                    Detailed progress tracking toward specific learning goals, milestones, and achievements would be
                    displayed here.
                  </p>
                </CardContent>
              </Card>
